 ...
 * <p>
 * 思路：
 * 1.由上题学会了怎么求二叉树的深度，借用dfs或bfs的方式求的左右子树的深度，并判断是否符合平衡二叉树的条件，不符合直接返回false,符合则对左右子树进行递归判断
 * 2.深度优先，对左右子树的深度差进行判断
 */
public class Solution {
    ...
    public int dfs(TreeNode root) {
        ...
        if (root == null) return 0;//root等于null时，该节点符合要求，返回其深度0，而不返回-1；
